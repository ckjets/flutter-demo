define(['dart_sdk', 'packages/typed_data/typed_buffers'], function(dart_sdk, packages__typed_data__typed_buffers) {
  ...
  let DiagnosticableNodeOfDiagnosticableMixin = () => (DiagnosticableNodeOfDiagnosticableMixin = dart.constFn(diagnostics$.DiagnosticableNode$(diagnostics$.DiagnosticableMixin)))();
  ...
  dart.defineLazy(CT, {
    ...
    get C48() {
      return C48 = dart.constSet(core.String, ["dart:async-patch", "dart:async", "package:stack_trace"]);
    },
    get C49() {
      return C49 = dart.constSet(core.String, ["_AssertionError", "_FakeAsync", "_FrameCallbackEntry"]);
    },
    get C50() {
      return C50 = dart.fn(assertions.FlutterError.dumpErrorToConsole, FlutterErrorDetails__Tovoid());
    },
    get C51() {
      return C51 = dart.fn(assertions.FlutterError.defaultStackFilter, IterableOfStringToIterableOfString());
    },
    get C52() {
      return C52 = dart.fn(assertions.DiagnosticsStackTrace._createStackFrame, StringToDiagnosticsNode());
    },
    get C53() {
      return C53 = dart.fn(binding._exitApplication, VoidToFutureOfvoid());
    },
    get C54() {
    ...
    get C59() {
      return C59 = dart.constList([C57 || CT.C57, C58 || CT.C58], licenses._LicenseEntryWithLineBreaksParserState);
    }
  });
  let C0;
  ...
  assertions.FlutterError = class FlutterError extends Error_DiagnosticableTreeMixin$36 {
    ...
    static defaultStackFilter(frames) {
      let t5;
      let filteredPackages = C48 || CT.C48;
      let filteredClasses = C49 || CT.C49;
  ...
  (assertions.DiagnosticsStackTrace.new = function(name, stack, opts) {
    ...
    let stackFilter = opts && 'stackFilter' in opts ? opts.stackFilter : null;
    let showSeparator = opts && 'showSeparator' in opts ? opts.showSeparator : true;
    assertions.DiagnosticsStackTrace.__proto__.new.call(this, {name: name, value: stack, properties: stack == null ? JSArrayOfDiagnosticsNode().of([]) : (t5 = stackFilter, t5 == null ? C51 || CT.C51 : t5)(dart.toString(stack)[$trimRight]()[$split]("\n"))[$map](diagnostics$.DiagnosticsNode, C52 || CT.C52)[$toList](), style: diagnostics$.DiagnosticsTreeStyle.flat, showSeparator: showSeparator, allowTruncate: true});
    ;
  ...
  binding.BindingBase = class BindingBase extends core.Object {
    ...
    initServiceExtensions() {
      ...
      if (!false && !true) {
        this.registerSignalServiceExtension({name: "exit", callback: C53 || CT.C53});
  ...
  licenses._LicenseEntryWithLineBreaksParserState.beforeParagraph = C57 || CT.C57;
  licenses._LicenseEntryWithLineBreaksParserState.inParagraph = C58 || CT.C58;
  licenses._LicenseEntryWithLineBreaksParserState.values = C59 || CT.C59;
