define(['dart_sdk', 'packages/flutter/src/foundation/_bitfield_web', 'packages/flutter/src/gestures/arena', 'packages/flutter/gestures', 'packages/vector_math/vector_math_64'], function(dart_sdk, packages__flutter__src__foundation___bitfield_web, packages__flutter__src__gestures__arena, packages__flutter__gestures, packages__vector_math__vector_math_64) {
  ...
  decoration.Decoration = class Decoration extends diagnostics.Diagnosticable {
    toStringShort() {
      return dart.str(object.objectRuntimeType(this, "Decoration"));
    }
    debugAssertIsValid() {
      return true;
    }
  ...
  const _createErrorHandlerAndKey = dart.privateName(image_provider, "_createErrorHandlerAndKey");
  ...
  (image_provider.AssetBundleImageKey.new = function(opts) {
    ...
    this[name$] = name;
    this[scale$] = scale;
    if (!(bundle != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 507, 15, "bundle != null");
    if (!(name != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 508, 15, "name != null");
    if (!(scale != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 509, 15, "scale != null");
    ;
  ...
  image_provider.ResizeImage = class ResizeImage extends image_provider.ImageProvider$(image_provider._SizeAwareCacheKey) {
    ...
    load(key, decode) {
      ...
      let decodeResize = dart.fn((bytes, opts) => {
        ...
        if (!(cacheWidth == null && cacheHeight == null)) dart.assertFailed("ResizeImage cannot be composed with another ImageProvider that applies cacheWidth or cacheHeight.", "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 645, 9, "cacheWidth == null && cacheHeight == null");
  ...
  (image_provider.ResizeImage.new = function(imageProvider, opts) {
    ...
    if (!(width != null || height != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 618, 15, "width != null || height != null");
  ...
  image_provider.FileImage = class FileImage extends image_provider.ImageProvider {
    ...
    [_loadAsync](key, decode) {
      return async.async(ui.Codec, (function* _loadAsync() {
        if (!dart.equals(key, this)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 733, 12, "key == this");
  ...
  (image_provider.FileImage.new = function(file, opts) {
    ...
    this[file$] = file;
    this[scale$0] = scale;
    if (!(file != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 707, 14, "file != null");
    if (!(scale != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 708, 14, "scale != null");
  ...
  image_provider.MemoryImage = class MemoryImage extends image_provider.ImageProvider {
    ...
    [_loadAsync](key, decode) {
      if (!dart.equals(key, this)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 798, 12, "key == this");
  ...
  (image_provider.MemoryImage.new = function(bytes, opts) {
    ...
    this[bytes$] = bytes;
    this[scale$1] = scale;
    if (!(bytes != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 775, 14, "bytes != null");
    if (!(scale != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 776, 14, "scale != null");
  ...
  (image_provider.ExactAssetImage.new = function(assetName, opts) {
    ...
    if (!(assetName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 904, 15, "assetName != null");
    if (!(scale != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 905, 15, "scale != null");
  ...
  (image_provider.NetworkImageLoadException.new = function(opts) {
    ...
    this[uri$] = uri;
    if (!(uri != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 983, 16, "uri != null");
    if (!(statusCode != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 984, 16, "statusCode != null");
  ...
  text_style.TextStyle = class TextStyle extends diagnostics.Diagnosticable {
    ...
    toStringShort() {
      return dart.str(object.objectRuntimeType(this, "TextStyle"));
    }
  ...
  strut_style.StrutStyle = class StrutStyle extends diagnostics.Diagnosticable {
    ...
    toStringShort() {
      return dart.str(object.objectRuntimeType(this, "StrutStyle"));
    }
    debugFillProperties(properties, opts) {
      let prefix = opts && 'prefix' in opts ? opts.prefix : "";
      super.debugFillProperties(properties);
  ...
  text_span.TextSpan = class TextSpan extends inline_span.InlineSpan {
    ...
    toStringShort() {
      return dart.str(object.objectRuntimeType(this, "TextSpan"));
    }
    debugFillProperties(properties) {
      let t18, t18$;
      super.debugFillProperties(properties);
  ...
  const _textHeightBehavior = dart.privateName(text_painter, "_textHeightBehavior");
  ...
  text_painter.TextPainter = class TextPainter extends core.Object {
    ...
    getBoxesForSelection(selection) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 815, 12, "!_needsLayout");
      return this[_paragraph].getBoxesForRange(selection.start, selection.end);
    }
    getPositionForOffset(offset) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 821, 12, "!_needsLayout");
      return this[_paragraph].getPositionForOffset(offset);
    }
    getWordBoundary(position) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 833, 12, "!_needsLayout");
      return this[_paragraph].getWordBoundary(position);
    }
    getLineBoundary(position) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 841, 12, "!_needsLayout");
      return this[_paragraph].getLineBoundary(position);
    }
    computeLineMetrics() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 861, 12, "!_needsLayout");
  ...
  flutter_logo._FlutterLogoPainter = class _FlutterLogoPainter extends decoration.BoxPainter {
    ...
    paint(canvas, offset, configuration) {
      ...
      if (dart.notNull(this[_config$][_opacity]) < 1.0) {
        canvas.saveLayer(offset['&'](canvasSize), (t18 = ui.Paint.new(), t18.colorFilter = new _engine.EngineColorFilter.mode((C152 || CT.C152).withOpacity(this[_config$][_opacity]), ui.BlendMode.modulate), t18));
      }
      if (this[_config$][_position] !== 0.0) {
        if (dart.notNull(this[_config$][_position]) > 0.0) {
          ...
          this[_textPainter].paint(canvas, ui.Offset.zero);
          if (dart.notNull(this[_config$][_position]) > -1.0) {
            canvas.drawRect(this[_textBoundingRect].inflate(dart.notNull(this[_textBoundingRect].width) * 0.5), (t18$0 = ui.Paint.new(), t18$0.blendMode = ui.BlendMode.modulate, t18$0.shader = ui.Gradient.linear(new ui.Offset.new(dart.notNull(this[_textBoundingRect].width) * -0.5, 0.0), new ui.Offset.new(dart.notNull(this[_textBoundingRect].width) * 1.5, 0.0), JSArrayOfColor().of([C152 || CT.C152, C152 || CT.C152, C153 || CT.C153, C153 || CT.C153]), JSArrayOfdouble().of([0.0, math.max(core.double, 0.0, this[_config$][_position][$abs]() - 0.1), math.min(core.double, this[_config$][_position][$abs]() + 0.1, 1.0), 1.0])), t18$0));
          }
          canvas.restore();
        }
      }
