...
let modulePaths = {
 ...
 "packages/myapp/main_web_entrypoint": "packages/myapp/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/myapp/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:myapp/main_web_entrypoint.dart") {
          // Clear static caches.
